...
const champClass =
  'flex-1 px-3 py-3 text-base rounded-xl border border-[#D9D2C4] bg-white text-[#1A1A1A] focus:outline-none focus:border-[#005B9E] focus:ring-2 focus:ring-[#005B9E]/25'
